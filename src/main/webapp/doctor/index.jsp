...
<head>
    ...
    <script type="text/javascript">
        function totalPage() {
            $("#pageNo").val(1);
            $("#form1").attr("action", "<%=path%>/docsFind.action");
            $("#form1").submit();
            return false;
        }
    ...
    <script type="text/javascript">
        ...
        function clearA() {
            $("input[name='doctor.docid']").val("");
            $("input[name='doctor.doctorname']").val("");
...
<body>
<form id="form2" action="<%=path%>/down" method="post" hidden>
    <input type="hidden" name="url" value="">
</form>
<form id="form1" action="<%=path%>/docsFind.action" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            <td width="10%" class="tableleft">医生编号：</td>
            <td><input type="text" name="doctor.docid" value="${doctor.docid!=0?doctor.docid:""}"/></td>
